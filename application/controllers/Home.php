...
class home extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->session->userdata('email')) {
            $user = $this->model user->cekdata(['email' => $this->session->userdata('email')])->row_array();
            ...
            $this->load->view('tamplates/tamplates-user/modal'), $data);
            $this->load->view('tamplates/tamplates-user/footer'), $data);
        } else {
